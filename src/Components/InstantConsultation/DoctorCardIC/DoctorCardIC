...
const DoctorCardIC = ({ name, speciality, experience, location, clinic, ratings, profilePic }) => {
    ...
    <div className="doctor-card-container">
      <div className="doctor-card-details-container">
        <div className="doctor-card-profile-image-container">
          <img src={profilePic} alt="JJ" />
       {/* <img src={"D:\\SkillUp\\projects\\main\\walkthroughproject\\stayhealthy\\server\\public\\doctor_images\\"+profilePic} className='doc_image' alt={name} /> */}
        </div>
